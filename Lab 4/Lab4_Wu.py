...
print(f"items in the dictonary {contacts.items()}")
# keys method returns all key in the dictionary
print(f"all keys in the dictonary {contacts.keys()}")
# values method returns all key in the dictionary
print(f"all values in the dictonary {contacts.values()}")

print("\n----- Example 4: check if a key is 'in' or 'not in' in a dictionary")
check_name = 'Trucy'
